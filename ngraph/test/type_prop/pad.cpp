...
TEST(type_prop, pad_v8_arg_pad_value_type_mismatch) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i64, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::i64, Shape{1});
    auto arg_pad_value = make_shared<op::Parameter>(element::f16, Shape{1});
    ...
    try {
        auto pad_v8 = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, arg_pad_value, op::PadMode::CONSTANT);
...
TEST(type_prop, pad_v8_arg_pad_value_shape_not_compatible) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i64, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::i64, Shape{1});
    auto arg_pad_value = make_shared<op::Parameter>(element::f32, Shape{1});
...
TEST(type_prop, pad_v8_pads_begin_shape_not_1D) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i64, Shape{1, 2});
    auto pads_end = make_shared<op::Parameter>(element::i64, Shape{1});

    try {
        auto pad_v8 = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, op::PadMode::SYMMETRIC);
...
TEST(type_prop, pad_v8_pads_end_shape_not_1D) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i64, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::i64, Shape{1, 2});
...
TEST(type_prop, pad_v8_pads_begin_size_not_correct) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i64, Shape{4});
    auto pads_end = make_shared<op::Parameter>(element::i64, Shape{1});
...
TEST(type_prop, pad_v8_pads_end_size_not_correct) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i64, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::i64, Shape{4});
    auto arg_pad_value = make_shared<op::Parameter>(element::f32, Shape{});
...
TEST(type_prop, pad_v8_arg_pads_begin_incompatible_type) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::f32, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::i64, Shape{1});

    try {
        auto pad_v8 = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, op::PadMode::REFLECT);
...
TEST(type_prop, pad_v8_arg_pads_end_incompatible_type) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i64, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::f32, Shape{1});

    try {
        auto pad = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, op::PadMode::REFLECT);
...
TEST(type_prop, pad_v8_deduce_too_small_for_edge) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 5, 0, 2});
    auto pads_begin = make_shared<op::Constant>(element::i64, Shape{4}, std::vector<int64_t>{0, 1, 2, 3});
    auto pads_end = make_shared<op::Constant>(element::i64, Shape{4}, std::vector<int64_t>{0, 1, 2, 3});
    auto arg_pad_value = make_shared<op::Parameter>(element::f32, Shape{});
    ...
    try {
        auto pad_v8 = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, arg_pad_value, op::PadMode::EDGE);
...
TEST(type_prop, pad_v8_deduce_too_small_for_reflect) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 5, 1, 2});
    auto pads_begin = make_shared<op::Constant>(element::i64, Shape{4}, std::vector<int64_t>{0, 1, 2, 3});
    auto pads_end = make_shared<op::Constant>(element::i64, Shape{4}, std::vector<int64_t>{0, 1, 2, 3});
    auto arg_pad_value = make_shared<op::Parameter>(element::f32, Shape{});
    ...
    try {
        auto pad_v8 = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, arg_pad_value, op::PadMode::REFLECT);
...
TEST(type_prop, pad_v8_deduce_too_small_for_circular) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 5, 0, 2});
    auto pads_begin = make_shared<op::Constant>(element::i64, Shape{4}, std::vector<int64_t>{0, 1, 2, 3});
    auto pads_end = make_shared<op::Constant>(element::i64, Shape{4}, std::vector<int64_t>{0, 1, 2, 3});
    auto arg_pad_value = make_shared<op::Parameter>(element::f32, Shape{});
    ...
    try {
        auto pad_v8 = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, arg_pad_value, op::PadMode::CIRCULAR);

        // Should have thrown, so fail if it didn't
        FAIL() << "Incorrect input shape exception for CIRCULAR mode not thrown";
    } catch (const NodeValidationFailure& error) {
        EXPECT_HAS_SUBSTRING(error.what(),
                             std::string("CIRCULAR padding mode requires an input of dimension of "
                                         "at least 1 at each spatial axis."));
    } catch (...) {
        FAIL() << "Deduced type check failed for unexpected reason";
    }
}

TEST(type_prop, pad_v8_dynamic_output_with_dynamic_rank) {
    auto arg = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto pads_begin = make_shared<op::Parameter>(element::i32, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::i32, Shape{1});
    auto arg_pad_value = op::Constant::create(element::f32, Shape{}, {0});

    auto pad = make_shared<op::v8::Pad>(arg, pads_begin, pads_end, arg_pad_value, op::PadMode::CONSTANT);
    ASSERT_EQ(pad->get_output_partial_shape(0), PartialShape::dynamic());
}

TEST(type_prop, pad_v8_dynamic_output_with_static_rank) {
    auto arg = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
    auto pads_begin = make_shared<op::Parameter>(element::i32, Shape{1});
    auto pads_end = make_shared<op::Parameter>(element::i32, Shape{1});
    auto arg_pad_value = op::Constant::create(element::f32, Shape{}, {0});
