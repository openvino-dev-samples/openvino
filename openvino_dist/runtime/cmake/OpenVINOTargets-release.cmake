...
set_target_properties(openvino::frontend::onnx PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_onnx_frontend.so.2022.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino_onnx_frontend.so.2230"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::onnx )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::onnx "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_onnx_frontend.so.2022.3.0" )
...
set_target_properties(openvino::frontend::paddle PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_paddle_frontend.so.2022.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino_paddle_frontend.so.2230"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::paddle )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::paddle "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_paddle_frontend.so.2022.3.0" )
...
set_target_properties(openvino::frontend::tensorflow PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_tensorflow_frontend.so.2022.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino_tensorflow_frontend.so.2230"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::tensorflow )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::tensorflow "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_tensorflow_frontend.so.2022.3.0" )
...
set_target_properties(openvino::runtime PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino.so.2022.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino.so.2230"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::runtime )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::runtime "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino.so.2022.3.0" )
...
set_target_properties(openvino::runtime::c PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_c.so.2022.3.0"
  IMPORTED_SONAME_RELEASE "libopenvino_c.so.2230"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::runtime::c )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::runtime::c "${_IMPORT_PREFIX}/runtime/lib/intel64/libopenvino_c.so.2022.3.0" )
